...
namespace NUgetUnicorn.Console
{
    internal class Options
    {
        ...
        [Option('s', "solution-path", DefaultValue = "", HelpText = "this is a solution path", Required = true)]
        ...
        public string GetUsage()
        {
            ...
            usage.AppendLine("You can always read the code (hehehe) on github: https://github.com/shilonosov/NugetUnicorn");
